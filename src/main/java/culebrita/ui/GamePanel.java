...
/**
 * Lienzo del juego: pinta grilla, culebra, comida, puntaje y menús. No calcula reglas.
 */
public final class GamePanel extends JPanel {
    ...
    /** Swing llama esto cada vez que hay que redibujar. */
    @Override
    ...
    /** La cabeza (i == 0) va más clara y un poco más grande que el cuerpo. */
    ...
    /** Barra superior: puntaje de esta partida, récord histórico y dificultad. */
    ...
    /** Capa oscura encima cuando no se está jugando (menú, pausa, game over). */
    ...
    /** Orden: título, "Dificultad", tres recuadros, recuadro ENTER, instrucción. */
    ...
    /** El recuadro de la dificultad actual se pinta en verde. */
